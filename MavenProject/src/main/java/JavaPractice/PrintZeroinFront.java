...
public class PrintZeroinFront {
		...
		public void secondMethod() {
			...
			String s ="32400121200";
			String[] s1= s.split("");
			String zeroStr3 = null ;
			String zeroStr4 = null;
			for (String string3 : s1) {
				//System.out.println(string);
				if(string3.equals("0")) {
				zeroStr3 = string3;
				System.out.println(zeroStr3);
											}
				else {
					zeroStr4 = string3;
					System.out.println(zeroStr4);
		...
		public void fourthMethod() {
			String inputStr ="32400121200";
			//char zeroStr ;
			//char strWithoutZero;
			char[] charArr = inputStr.toCharArray();
			String zeroStr = null;
			String strWithoutZero = null;
			for(char c: charArr) {
			...
			} 			System.out.println(zeroStr+strWithoutZero);
